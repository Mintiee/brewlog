...
export const SEED_COFFEES: Coffee[] = [
  {
    ...
    origin: "Ethiopia", region: "Sidama, Bensa", varietals: ["Heirloom"], process: "Washed",
    ...
    notes: ["Jasmine", "Bergamot", "White peach"], cc: "et",
  },
  {
    id: "onyx-geo", household_id: "seed", roaster: "Onyx", name: "Geometry",
    origin: "Blend", region: "Colombia · Ethiopia", varietals: ["Caturra", "Heirloom"], process: "Washed",
  ...
  },
  {
    ...
    notes: ["Jasmine", "Bergamot", "Honeysuckle"], cc: "pa",
  },
  {
    id: "heart-brisas", household_id: "seed", roaster: "Heart", name: "Las Brisas",
    origin: "Costa Rica", region: "Tarrazú", varietals: ["Caturra"], process: "Honey",
    roast: "medium", roasted_at: daysAgoDate(60), rest_days: 28, peak_days: 56,
    grams: 340, frozen_grams: 0, frozen_at: null, thawed_at: null, archived: false,
    notes: ["Brown sugar", "Plum", "Walnut"], cc: "cr",
  },
];
